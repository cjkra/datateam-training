...
These commands will launch a Shiny app in your web browser. Note that R cannot run other code when a Shiny app is open.
...
The tables you constructed in the app will be assigned to the `atts` variable as a list of data frames (one for attributes, factors, and units). Alternatively, each table can be to exported to a csv file by clicking the `Download` button.
